...
alias cc='cabal --enable-nix configure --enable-tests'
alias cb='cabal --enable-nix build --ghc-options=-Werror'
alias cbt='cabal --enable-nix build --ghc-options=-Werror && cabal --enable-nix test'
alias cbti='cabal --enable-nix build --ghc-options=-Werror && cabal --enable-nix test && cabal --enable-nix install'
